...
- Press, hold, scrub, live-level, and visualizer frames animate transform/opacity through shared values.
- Hold-to-record crosses to JavaScript only for start, cancel, lock, release, and causal haptics.
